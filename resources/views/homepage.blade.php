...
<body class="bg-gray-100 overflow-x-hidden">
    <nav class="bg-custom-darkBlue py-4">
        <div class="w-full container mx-10 flex justify-between items-center">
            ...
            <ul class="flex space-x-6 text-white w-16">
                <li><a href="#" class="hover:border-b hover:border-custom-gold">Home</a></li>
                <li><a href="#" class="hover:border-b hover:border-custom-gold">Store</a></li>
    ...
    <div class="bg-gray-700 py-3 mt-4 mb-0">
