    ...
    <section class="Delship py-10 w-full">
        <section class="FAQheader bg-white shadow-md py-6">
            <div class="container mx-auto px-4 flex flex-col justify-center items-center">
                <h1 class="FAQ__h1 text-6xl font-bold mb-7 text-center text-gray-800 my-5">Delivery and Shipping</h1>
                <p class="FAQ__p text-2xl text-gray-600 text-center mb-5">Learn more about delivery and shipping</p>
            </div>
        </section>
        <section class="FAQcontent mt-8 content-start">
            <div class="container mx-auto items-center flex flex-col justify-center">
                ...
                <div x-data="{ open: false }" class="w-full md:w-6/12">
                    <button @click="open = !open" class="FAQcontent__btn FAQcontent__btn--1 w-full text-3xl text-center font-semibold bg-white shadow-md p-4 mb-2 focus:outline-none">
                        Which areas do you deliver?
                    </button>
                    <div x-show="open" class="del__content del__content--1 text-3xl text-center bg-gray-100 p-4 mb-4">
                        We deliver nationwide.
                    </div>
                </div>
                <br/>
                <div x-data="{ open: false }" class="w-full md:w-6/12">
                    <button @click="open = !open" class="FAQcontent__btn FAQcontent__btn--2 w-full text-3xl text-center font-semibold bg-white shadow-md p-4 mb-2 focus:outline-none">
                        Which couriers do you use?
                    </button>
                    <div x-show="open" class="del__content del__content--2 text-3xl text-center bg-gray-100 p-4 mb-4">
                ...
                <br/>
                <div x-data="{ open: false }" class="w-full md:w-6/12">
                    <button @click="open = !open" class="FAQcontent__btn FAQcontent__btn--3 w-full text-3xl text-center font-semibold bg-white shadow-md p-4 mb-2 focus:outline-none">
                        How long do I have to wait before I get my order?
                    </button>
                    <div x-show="open" class="del__content del__content--3 text-3xl text-center bg-gray-100 p-4 mb-4">
                ...
                <br/>
                <div x-data="{ open: false }" class="w-full md:w-6/12">
                    <button @click="open = !open" class="FAQcontent__btn FAQcontent__btn--4 w-full text-3xl text-center font-semibold bg-white shadow-md p-4 mb-2 focus:outline-none">
                        Do you offer free shipping?
                    </button>
                    <div x-show="open" class="del__content del__content--4 text-3xl text-center bg-gray-100 p-4 mb-4">
